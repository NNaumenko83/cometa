export const linkbuilderJob = {
    vacancy: 'LINKBUILDER',
    title: '🎮🌟 Creative Linkbuilder in Web3 GameDev 🌟🎮',
    description:
        'Hello, gamers and interactive story enthusiasts! Our company is looking for a modern, vibrant, and ambitious Linkbuilder ready to create thrilling and exciting Master of Backlinks for our gaming project 🚀',
    ...
    offer: {
        ...
        list: [
            ...
            'Professional Development: Participate in the best Linkbuilder conferences, trainings, and seminars.',
