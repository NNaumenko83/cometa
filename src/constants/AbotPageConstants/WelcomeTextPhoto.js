...
export const welcomeTextPhoto = Object.freeze({
    ...
    title: 'WELCOME TO COMETA SPACE',

    text: {
        paragraph1: `At Cometa Space, we are a team of passionate professionals on a mission to redefine the boundaries between gaming and real-world economics. 
